module Giraffi
  class Client
    ...
    module Services
      ...
      #
      # @requires_apikey Yes
      # @params options [Hash] The request params to retrieve the desired services
      ...
      #
      # @requires_apikey Yes
      # @params id [String] The numerical ID of the desired service
      # @return [HTTParty::Response]
      def find_service(id)
      ...
      #
      # @requires_apikey Yes
      # @params id [String] The numerical ID of the related service
      # @params options [Hash] A set of attributes for a trigger to add to the service
      # @return [HTTParty::Response]
      ...
      # @requires_apikey Yes
      # @params id [String] The numerical ID of the desired service
      # @params options [Hash] A set of attributes to update the service
      # @return [HTTParty::Response]
      ...
      #
      # @requires_apikey Yes
      # @params args [Array] A set of params to update the region
      # @arg args [String] The numerical ID of the related service
      # @arg args [String] The region code(e.g JP) to update
      # @return [HTTParty::Response]
      def update_region_by_service(*args)
        raise ArgumentError.new('The method `update_region_by_service` requires 2 arguments (service-id and region-code).') if args.size != 2
      ...
      #
      # @requires_apikey Yes
      # @params args [Array] A set of params to remove a trigger from the service
      # @arg args [String] The numerical ID of the related service
      # @arg args [String] The numerical ID of the trigger to remove
      # @return [HTTParty::Response]
